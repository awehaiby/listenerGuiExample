...
/**
 * The <code>TcsPacket</code> class represents a data packet.
 ...
 * @author ibr, hbe
 */
public final class TcsPacket extends Packet {
    ...
    private final int DATALENGTHSIZE = 2;
    ...
    /**
     * Constructs a new <code>TcsPacket</code> based upon the source, destination,
     ...
     */
    public TcsPacket(String source, String destination, String commandStatus, String data) {
    ...
    /**
     * Constructs a new <code>TcsPacket</code> from the byte array supplied.
     * The byte array should contain data corresponding to all the <code>TcsPacket</code>
     * fields. The byte array is parsed and the <code>TcsPacket</code> constructed.
     * @param bytePacket the byte array containing the data for all the <code>TcsPacket</code> fields.
     */
    public TcsPacket(byte[] bytePacket) {
    ...
    /**
     * Returns the <code>TcsPacket</code> contents as a byte array.
     * @return the <code>TcsPacket</code> contents as a byte array.
     */
    @Override
    ...
    /**
     * Populate the byte array representing the <code>TcsPacket</code> contents
     ...
     * <code>TcsPacket</code> data frame by comparing the number of bytes in the
     ...
     * for the concrete strategy class <code>TcsPacket</code> in the
     ...
     * <code>TcsPacket</code> data frame, <code>false</code> otherwise.
     */
    @Override
    ...
    public boolean equals(Object obj) {
        ...
        final TcsPacket other = (TcsPacket) obj;
